...
import { deleteFaculty } from "../../store/ApiSlice/facultySlice";
import {
  getAccounts,
  getAccountsById,
          ...
          >
            ...
            {user.role === "Organization" && (
              ...
              >
                <div
                  onClick={() => {
                    dispatch(deleteFaculty(row.row.id)).then(() => {
                      if (user?.role === "Admin") {
  ...
  return (
    <Box m="20px">
      <Box display="flex" alignItems="center" justifyContent="space-between">
        <Header
          title="FACULTIES"
          subtitle="Faculties conducts lectures and provides notes, materials and announcements."
        />
          ...
          {user.role === "Organization" ? (
            ...
            >
              <div
                ...
                onClick={() => {
                  dispatch(setButtonType("faculty"));
                  navigate("/form");
                }}
              >
      ...
      >
        <DataGrid
          checkboxSelection
          rows={accounts.data.faculties ? accounts.data.faculties : []}
          columns={columns}
